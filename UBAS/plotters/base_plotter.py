...
class BasePlotter:
    ...
    def generate_plots(self, iteration, x, x_new, y_preds, y_bounds, y_exact, y_new_exact):
        ...
        for plot in self.plots:
            ...
            plot = self.supported_graphs[plot](path, x_df, y_df, **self.plotting_params)

    @staticmethod
    def scatter_matrix(path, x_df, y_df, *args, **kwargs):
        """
    ...
    @staticmethod
    def pred_vs_actual(path, x_df, y_df, *args, **kwargs):
        """
